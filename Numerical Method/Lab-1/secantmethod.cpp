...
int main() {
    ...
    double x0, x1, fx0, fx1, result, finalResult, error = 0;
    ...
    do {
        ...
        cout << setw(15) << i << setw(15) << x0 << setw(15) << fx0 << setw(15) << x1 << setw(15) << fx1 << setw(15) << result << setw(15) << finalResult << setw(15) << error << endl;
